(function () {
    document.getElementById('button-room').addEventListener('click', function () {
        ...
        `,
            ...
            if (result.isConfirmed) {
                ...
                <!-- Bootstrap style sheet for CSS-->
                <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
                <div class="p-1">Recibirá un correo de confirmación cuando su solicitud sea aprobada por la Oficina de Planeación Académica.</div>
                `,
