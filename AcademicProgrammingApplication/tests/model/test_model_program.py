...
class ProgramModelTest(TestCase):  # Defining a test case class for Program model
    def setUp(self):  # Setting up initial conditions for each test
        """
        Creates Semester, Subject, and Program objects for testing.
        """
        ...
        self.program = Program.objects.create(
            ...
            modality='PRESENCIAL',
            duration='2 años',
            curriculum=SimpleUploadedFile("file.pdf", b"file_content", content_type="application/pdf"),
            # Creating a SimpleUploadedFile object for curriculum
        )
    ...
    def test_program_creation(self):  # Test for Program object creation
        """
        Verifies that the Program object is created successfully.
        """
    ...
    def test_program_str(self):  # Test for __str__ method of Program model
        """
        Verifies that the __str__ method of Program model works correctly.
        """
    ...
    def test_program_attributes(self):  # Test for attributes of Program model
        """
        Verifies that the attributes of Program model are correct.
        """
    ...
    def test_program_relations(self):  # Test for relations of Program model
        """
        Verifies that the relations of Program model are correct.
        """
