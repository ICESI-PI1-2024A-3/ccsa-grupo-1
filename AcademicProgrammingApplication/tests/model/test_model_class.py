...
class ClassModelTest(TestCase):  # Defining a test case class for Class model
    def setUp(self):  # Setting up initial conditions for each test
        # Creating Subject and Teacher objects for testing
    ...
    def test_class_creation(self):  # Test for Class object creation
    ...
    def test_class_str(self):  # Test for __str__ method of Class model
        # Creating a Class object for testing
        class_obj = Class.objects.create(
            id='123',
            start_date='2022-01-01T00:00:00Z',
    ...
    def test_class_save_validation_error(self):  # Test for validation error on saving Class object
