...
class SubjectModelTest(TestCase):  # Defining a test case class for Subject model
    def setUp(self):  # Setting up initial conditions for each test
        """
        Creates a Subject object for testing.
        """
