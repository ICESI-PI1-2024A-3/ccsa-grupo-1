# Generated by Django 5.0.3 on 2024-04-29 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.FileField(default='BasePlanningAcademicProgramming.xlsx', upload_to='files/')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viatic_status',
                 models.CharField(choices=[('ENVIADA', 'Enviada'), ('NO_ENVIADA', 'No Enviada')], default='NO_ENVIADO',
                                  max_length=200, verbose_name='Estado del viático')),
                ('id_teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 to='AcademicProgrammingApplication.teacher',
                                                 verbose_name='Profesor asociado')),
            ],
        ),
